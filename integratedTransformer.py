...
class TwoDirectionalMultiDimAttention(nn.Module):
    ...
    def forward(self, x, tfidf_scores):
        ...
        tfidf_scores = tfidf_scores.unsqueeze(1).unsqueeze(-1)  # [batch_size, 1, seq_length, 1]
        tfidf_scores = tfidf_scores.expand(batch_size, seq_length, seq_length, self.num_dims) 
